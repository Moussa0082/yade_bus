...
class AgentVoyageReserv extends StatefulWidget {
  final int? idDepart;
  final int? idDest;
  ...
  @override
  State<AgentVoyageReserv> createState() => _AgentVoyageReservState();
}

class _AgentVoyageReservState extends State<AgentVoyageReserv>
